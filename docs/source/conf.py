# -*- coding: utf-8 -*-
#
# Plyer documentation build configuration file, created by
# sphinx-quickstart on Wed Jul  3 15:27:01 2013.
#
...
texinfo_documents = [
  ('index', 'Plyer', u'Plyer Documentation',
   u'Mathieu Virbel, Akshay Aurora, Gabriel Petier, Ben Rousch', 'Plyer', 'One line description of project.',
   'Miscellaneous'),
]
