...
Maps
=======
The :class:`Maps` creates a client for accessing the default Maps API. Depending on the platform, holds features such as opening a location by address & latitude/longitude, create queries, or find directions between two points
...
class Maps:
    ...
    def search(self, query, **kwargs):
        '''
        The query. This parameter is treated as if its value had been typed into the Maps search field by the user. Note that query=* is not supported
        '''
