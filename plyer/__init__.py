...
__all__ = ('accelerometer', 'audio', 'battery', 'call', 'camera', 'compass',
           ...
           'orientation', 'notification', 'qrbarcodereader', 'sms', 'tts',
...
#: QrBarcodeReader proxy to :class:'plyer.facades.QrBarcodeReader'
qrbarcodereader = Proxy('qrbarcodereader', facades.QrBarcodeReader)
