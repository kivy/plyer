...
from plyer.facades import GameRotation
...
class GameRotationSensorListener(PythonJavaClass):
    __javainterfaces__ = ['android/hardware/SensorEventListener']

    def __init__(self):
        super(GameRotationSensorListener, self).__init__()
...
class AndroidGameRotation(GameRotation):
    ...
    def _enable_listener(self, **kwargs):
        if not self.listener:
            self.listener = GameRotationSensorListener()
