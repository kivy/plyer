...
class LinuxBluetooth(Bluetooth):
    ...
    def _get_scan_devices(self):
        ...
        try:
            ...
            for line in out:
                ...
                string_valid = not any(keyword in line for keyword in
                                       block_list)
                if string_valid:
                    try:
                        ...
                        if device_position > -1:
                            attribute_list = line[device_position:].split(" ",
                                                                          2)
                            print(device)
    ...
    def _disconnect(self, name):
        ...
        try:
            ...
            res = self.child.expect(["Failed to disconnect",
                                     "Successful disconnected", pexpect.EOF])
