...
#:import facade plyer.gamerotation
<GameRotationInterface>:
    facade: facade
...
class GameRotationInterface(BoxLayout):
...
class GameRotationTestApp(App):
    def build(self):
        return GameRotationInterface()

if __name__ == "__main__":
    GameRotationTestApp().run()
