...
class ScreenShotDemo(FloatLayout):
    def __init__(self):
        super(ScreenShotDemo, self).__init__()
        self.cwd = getcwd() + "/"
    ...
    def do_capture(self):
        ...
        try:
            screenshot.take_shot(filename=filepath,
...
class ScreenshotDemoApp(App):
    def __init__(self):
        super(ScreenshotDemoApp, self).__init__()
        self.demo = None

    def build(self):
        self.demo = ScreenShotDemo()
        return self.demo
